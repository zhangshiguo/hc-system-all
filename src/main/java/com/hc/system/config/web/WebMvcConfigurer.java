...
import com.hc.system.interceptor.AuthenticationInterceptor;
...
//        registry.addInterceptor(new AuthenticationInterceptor()).addPathPatterns("/**").excludePathPatterns("/manage/list_area", "/manage/addarea", "/redis/test");
//        registry.addInterceptor(new AuthenticationInterceptor()).addPathPatterns("/**").excludePathPatterns("/manage/list_area");
